        ...
        <div id="carouselExampleFade" className="carousel slide carousel-fade " >
                <div className="carousel-inner " id='carousel' >
                    <div className="carousel-caption bg-transparent" style={{zIndex:"10"}}>
                        <div className="form-inline bg-transparent d-flex justify-content-center">
                          <input className="form-control mr-sm-2 text-dark me-2" type="search" placeholder="Search" aria-label="Search" 
        ...
        <div className='container'>
          {
            ...
            ? foodCat.map((data)=>{
              return(
                ...
                <div key={data._id} className='fs-3 m-5'>{data.CategoryName}</div>
                <hr />
                {
                  foodItem != [] ?
